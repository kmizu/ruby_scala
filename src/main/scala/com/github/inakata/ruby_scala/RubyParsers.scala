...
class RubyParsers extends RegexParsers with PackratParsers with TracableParsers {
  ...
  lazy val Spacing: Parser[String] = ((regex("""\s""".r) | Comment)*) ^^ { (_).mkString }
  lazy val anySpaceWithoutLT: Parser[String] = regex("""[ \t\f]*""".r) ~ ??(Comment) ^^ { case r~c => r+c }
  lazy val WS: Parser[String] = regex("""\s+""".r)
  lazy val ConstID: Parser[String] = Spacing~>regex("""[A-Z][a-zA-Z0-9_]*""".r)
  lazy val LocalID: Parser[String] = Spacing~>regex("""[a-z_][a-zA-Z0-9_]*""".r)
  lazy val MethodID: Parser[String] = Spacing~>regex("""m[a-zA-Z0-9_]*""".r)
  lazy val GlobalID: Parser[String] = Spacing~>regex("""\$[a-zA-Z_][a-zA-Z0-9_]*""".r)
  lazy val ClassID: Parser[String] = Spacing~>regex("""@@[a-zA-Z_][a-zA-Z0-9_]*""".r)
...
// 8.4 Whitespace
  ...
  lazy val SingleQUOTE: Parser[String] = Spacing~>"'"
  lazy val MULT: Parser[String] = Spacing~>"*"
  lazy val DIV: Parser[String] = Spacing~>"/"
  ...
  lazy val LBRACKET: Parser[String] = Spacing~>"["
  lazy val RBRACKET: Parser[String] = Spacing~>"]"
  lazy val QUESTION: Parser[String] = Spacing~>"?"
  lazy val COMMA: Parser[String] = Spacing~>","
  lazy val VerticalBAR: Parser[String] = Spacing~>"|"
  lazy val SEMICOLON: Parser[String] = Spacing~>";"
  lazy val COLON: Parser[String] = Spacing~>":"
  lazy val DoubleCOLON: Parser[String] = Spacing~>"::"
  lazy val PERIOD: Parser[String] = Spacing~>"."
  lazy val DoublePERIOD: Parser[String] = Spacing~>".."
  lazy val TriplePERIOD: Parser[String] = Spacing~>"..."
  lazy val AndOP: Parser[String] = Spacing~>"&&"
  lazy val OrOP: Parser[String] = Spacing~>"||"
  lazy val NotEQ: Parser[String] = Spacing~>"!="
  lazy val NotOP: Parser[String] = Spacing~>"!"
  lazy val NotTILDE: Parser[String] = Spacing~>"!~"
  lazy val AMPERSAND: Parser[String] = Spacing~>"&"

  lazy val ArrayEQ: Parser[String] =  Spacing~>"[]="
  lazy val ArraySYM: Parser[String] =  Spacing~>"[]"
  lazy val AndASSIGN: Parser[String] =  Spacing~>"&&="
  lazy val OrASSIGN: Parser[String] =  Spacing~>"||="
  lazy val HatASSIGN: Parser[String] =  Spacing~>"^="
  lazy val AmpersandASSIGN: Parser[String] =  Spacing~>"&="
  lazy val VerticalBarASSIGN: Parser[String] =  Spacing~>"|="
  lazy val LtLtASSIGN: Parser[String] =  Spacing~>"<<="
  lazy val GtGtASSIGN: Parser[String] =  Spacing~>">>="
  lazy val PlusASSIGN: Parser[String] =  Spacing~>"+="
  lazy val MinusASSIGN: Parser[String] =  Spacing~>"-="
  lazy val StarStarASSIGN: Parser[String] =  Spacing~>"**="
  lazy val StarASSIGN: Parser[String] =  Spacing~>"*="
  lazy val SlashASSIGN: Parser[String] =  Spacing~>"/="
  lazy val PercentASSIGN: Parser[String] =  Spacing~>"%="

  lazy val HAT: Parser[String] =  Spacing~>"^"
  lazy val LtEqGT: Parser[String] =  Spacing~>"<=>"
  lazy val TripleEQ: Parser[String] =  Spacing~>"==="
  lazy val DoubleEQ: Parser[String] =  Spacing~>"=="
  lazy val EqTILDE: Parser[String] =  Spacing~>"=~"
  lazy val EqGT: Parser[String] =  Spacing~>"=>"
  lazy val GtEQ: Parser[String] =  Spacing~>">="
  lazy val GtGT: Parser[String] =  Spacing~>">>"
  lazy val GT: Parser[String] =  Spacing~>">"
  lazy val LtLT: Parser[String] =  Spacing~>"<<"
  lazy val LtEQ: Parser[String] =  Spacing~>"<="
  lazy val LT: Parser[String] =  Spacing~>"<"
  lazy val EQUAL: Parser[String] =  Spacing~>"="
  lazy val PLUS: Parser[String] =  Spacing~>"+"
  lazy val PlusAT: Parser[String] =  Spacing~>"+@"
  lazy val MinusAT: Parser[String] =  Spacing~>"-@"
  lazy val MINUS: Parser[String] =  Spacing~>"-"
  lazy val StarSTAR: Parser[String] =  Spacing~>"**"
  lazy val STAR: Parser[String] =  Spacing~>"*"
  lazy val SLASH: Parser[String] =  Spacing~>"/"
  lazy val PERCENT: Parser[String] =  Spacing~>"%"
  lazy val TILDE: Parser[String] =  Spacing~>"~"
  lazy val BackQUOTE: Parser[String] =  Spacing~>"`"

  lazy val AND: Parser[String] = Spacing~>"and"
  lazy val OR: Parser[String] = Spacing~>"or"
  lazy val NOT: Parser[String] = Spacing~>"not"
  lazy val RETURN: Parser[String] = Spacing~>"return"
  lazy val BREAK: Parser[String] = Spacing~>"break"
  lazy val NEXT: Parser[String] = Spacing~>"next"
  lazy val SUPER: Parser[String] = Spacing~>"super"
  lazy val YIELD: Parser[String] = Spacing~>"yield"
  lazy val DO: Parser[String] = Spacing~>"do"
  lazy val END: Parser[String] = Spacing~>"end"
  lazy val LINE: Parser[String] = Spacing~>"__LINE__"
  lazy val ENCODING: Parser[String] = Spacing~>"__ENCODING__"
  lazy val FILE: Parser[String] = Spacing~>"__FILE__"
  lazy val UpBEGIN: Parser[String] = Spacing~>"BEGIN"
  lazy val UpEND: Parser[String] = Spacing~>"END"
  lazy val ALIAS: Parser[String] = Spacing~>"alias"
  lazy val BEGIN: Parser[String] = Spacing~>"begin"
  lazy val CASE: Parser[String] = Spacing~>"case"
  lazy val CLASS: Parser[String] = Spacing~>"class"
  lazy val DEF: Parser[String] = Spacing~>"def"
  lazy val DEFINED: Parser[String] = Spacing~>"defined?"
  lazy val ELSE: Parser[String] = Spacing~>"else"
  lazy val ELSIF: Parser[String] = Spacing~>"elsif"
  lazy val ENSURE: Parser[String] = Spacing~>"ensure"
  lazy val FOR: Parser[String] = Spacing~>"for"
  lazy val FALSE: Parser[String] = Spacing~>"false"
  lazy val IF: Parser[String] = Spacing~>"if"
  lazy val IN: Parser[String] = Spacing~>"in"
  lazy val MODULE: Parser[String] = Spacing~>"module"
  lazy val NIL: Parser[String] = Spacing~>"nil"
  lazy val REDO: Parser[String] = Spacing~>"redo"
  lazy val RESCUE: Parser[String] = Spacing~>"rescue"
  lazy val RETRY: Parser[String] = Spacing~>"retry"
  lazy val SELF: Parser[String] = Spacing~>"self"
  lazy val THEN: Parser[String] = Spacing~>"then"
  lazy val TRUE: Parser[String] = Spacing~>"true"
  lazy val UNDEF: Parser[String] = Spacing~>"undef"
  lazy val UNLESS: Parser[String] = Spacing~>"unless"
  lazy val UNTIL: Parser[String] = Spacing~>"until"
  lazy val WHEN: Parser[String] = Spacing~>"when"
  lazy val WHILE: Parser[String] = Spacing~>"while"
